...
var country_init = "Azerbaijan";
// var citation_text = "World Bank Development Indicators: Education expenditure (current US$)";
var citation_text = "World Bank DataBank";
var citation_url = "http://data.worldbank.org/indicator/NY.ADJ.AEDU.CD";
...
d3.json(datafile, function (error, data) {
    ...
    d3.select("body").append("div")
        ...
        .html("<small><em>Source: <a href='" + citation_url + "' target='_blank'>" + citation_text + "</a></em></small>");
